...
public class Matrix implements Parcelable {
    ...
    public Matrix() {}
    public Matrix(Parcel in) { readParcel(in); }
    ...
    public void toYRot(float angleY) {
        set((float) Math.cos(angleY), 0f, (float) Math.sin(angleY),
            0f, 1f, 0f,
    ...
    private float det2x2(float a, float b, float c, float d) { return  (a*d)-(b*c); }
    public float det() {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeFloat(b1);
        parcel.writeFloat(b2);
        parcel.writeFloat(b3);
        parcel.writeFloat(c1);
        parcel.writeFloat(c2);
        parcel.writeFloat(c3);
    }
